...
namespace MyMVCAPI.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SId,email,password")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SId,email,password")] Student student)
        {
            if (id != student.SId)
            {
                return NotFound();
